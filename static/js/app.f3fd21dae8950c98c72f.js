...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _vueResource = __webpack_require__(594);

	var _vueResource2 = _interopRequireDefault(_vueResource);

	var _vueLazyload = __webpack_require__(565);
	...
	_vue2.default.use(_vueLazyload2.default, {
	  error: __webpack_require__(185),
	  loading: __webpack_require__(185),
	  attempt: 1
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var PLAY_MODE_IMG = exports.PLAY_MODE_IMG = [__webpack_require__(553), __webpack_require__(552), __webpack_require__(551)];
	...
	var DEFAULT_IMG = exports.DEFAULT_IMG = __webpack_require__(550);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _PlayService = __webpack_require__(205);

	var _PlayService2 = _interopRequireDefault(_PlayService);

	var _ApiService = __webpack_require__(203);

	var _ApiService2 = _interopRequireDefault(_ApiService);

	var _NotifyService = __webpack_require__(204);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (browser) window.Swiper = __webpack_require__(182);
	exports.default = {
	  name: 'swiper',
	  props: {
	    options: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Play = __webpack_require__(573);

	var _Play2 = _interopRequireDefault(_Play);

	var _Rank = __webpack_require__(575);

	var _Rank2 = _interopRequireDefault(_Rank);

	var _Recommand = __webpack_require__(576);

	var _Recommand2 = _interopRequireDefault(_Recommand);

	var _ActionSheet = __webpack_require__(569);

	var _ActionSheet2 = _interopRequireDefault(_ActionSheet);

	var _PlayingList = __webpack_require__(574);

	var _PlayingList2 = _interopRequireDefault(_PlayingList);

	var _vuex = __webpack_require__(31);

	var _vueAwesomeSwiper = __webpack_require__(186);

	__webpack_require__(241);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var TAB_NAME = ["古典诗词", "流行音乐"];
	...
	exports.default = {
	  ...
	  data: function data() {
	    return {
	      iconPlay: __webpack_require__(47),
	      iconPause: __webpack_require__(560),
	      playPageShow: false,
	      blurBgShow: true,
	      rankshow: true,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  methods: {
	    ...
	    play: function play(index) {
	      var list = [];
	      this.cd.songlist.forEach(function (item) {
	        list.push({
	          id: item.id,
	          mid: item.mid,
	          name: item.name,
	  ...
	  computed: {
	    ...
	    color: function color() {
	      if (this.cd !== null) {
	        var fixed = '00000' + this.cd.uin.toString(16);
	  ...
	  created: function created() {
	    ...
	    this.$store.dispatch('getCdList', this.$route.params.id).then(function (response) {
	      _this.cd = response.data.cdlist[0];
	    });
	  ...
	  filters: {
	    listenCount: function listenCount(num) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Lyric = __webpack_require__(572);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _def = __webpack_require__(49);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  created: function created() {
	    ...
	    fetch('https://raw.githubusercontent.com/520Book/source/main/names.txt').then(function (response) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _mvitem = __webpack_require__(579);

	var _mvitem2 = _interopRequireDefault(_mvitem);
	...
	exports.default = {
	  ...
	  methods: {
	    jump: function jump(info) {
	      switch (info.type) {
	        case _def.types.ALBUM:
	          this.$router.push({
	            name: 'album',
	            params: {
	              id: info.id
	  ...
	  created: function created() {
	    ...
	    this.$store.dispatch('getRecommands').then(function (response) {
	      _this.loading = false;
	      _this.slider = response.data.data.focus;
	      _this.songList = response.data.data.hotdiss.list;
	      _this.mvList = response.data.data.shoubomv.all;
	    }, function (responce) {
	      _this.loadingState = '加载失败';
	    });
	  },
	  filters: {
	    listenCount: function listenCount(num) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _vueRouter = __webpack_require__(595);

	var _vueRouter2 = _interopRequireDefault(_vueRouter);

	var _Album = __webpack_require__(570);

	var _Album2 = _interopRequireDefault(_Album);

	var _Singer = __webpack_require__(578);

	var _Singer2 = _interopRequireDefault(_Singer);

	var _Cd = __webpack_require__(571);
	...
	var routes = [{ path: '/singer/:id', name: 'singer', component: _Singer2.default }, { path: '/album/:id', name: 'album', component: _Album2.default }, { path: '/cd/:id', name: 'cd', component: _Cd2.default }];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _objectDestructuringEmpty2 = __webpack_require__(211);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Rx = __webpack_require__(256);
	...
	exports.default = {
	  ...
	  mutations: {
	    ...
	    setPlayList: function setPlayList(state, playList) {
	      ...
	      console.log(state.playList, state.index, state.song);
	    },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-637c692a"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-20fbc702"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-5442fb4e"
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    attrs: {
	      "options": _vm.swiperOptionIn
	    }
	  }, [_vm._l((_vm.slider), function(s) {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: "author"
	  }, [_vm._v(_vm._s(_vm.author))]), _vm._v(" "), _c('p', {
	    staticClass: "date"
	  }, [_vm._v("发行时间:" + _vm._s(_vm.date))]), _vm._v(" "), _c('div', {
	    staticClass: "mv-playcount"
	  }, [_c('span', [_vm._v("播放量:" + _vm._s(_vm._f("listenCount")(_vm.playcount)))])])])])
	},staticRenderFns: []}
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    return _c('li', {
	      ...
	      staticClass: "music-singer"
	    }, [_c('span', [_vm._v(_vm._s(item.author))])])]), _vm._v(" "), _c('div', {
	      staticClass: "action-button",
	      on: {
	        "touchend": function($event) {
	          $event.preventDefault();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: "singer-name"
	  }, [_vm._v(_vm._s(_vm.cd.dissname))]), _vm._v(" "), _c('p', {
	    staticClass: "singer-fans"
	  }, [_vm._v(_vm._s(_vm._f("listenCount")(_vm.cd.visitnum)) + "播放 来自：" + _vm._s(_vm.cd.nick))])]), _vm._v(" "), _c('div', {
	    staticClass: "play-button",
	    on: {
	      "click": function($event) {
	        return _vm.play(0)
	  ...
	  })])])]) : _vm._e(), _vm._v(" "), (_vm.cd != null) ? _c('div', {
	    staticClass: "list",
	    style: ({
	      background: _vm.color
	    })
	  }, [_c('ul', _vm._l((_vm.cd.songlist), function(item, index) {
	    return _c('li', {
	      staticClass: "border-1px border-1px-after"
	    }, [_c('div', {
	      staticClass: "music-info",
	      ...
	      staticClass: "music-singer"
	    }, [_vm._l((item.singer), function(singername) {
	      return _c('span', [_vm._v(_vm._s(singername.name) + "-")])
	    }), _vm._v(" "), _c('span', [_vm._v(_vm._s(item.subtitle))])], 2)]), _vm._v(" "), _c('div', {
	      staticClass: "action-button",
	      on: {
	        "touchend": function($event) {
	          $event.preventDefault();
	  ...
	  }, [_c('p', [_vm._v(_vm._s(_vm.cd.desc))])])]) : _vm._e()])
	},staticRenderFns: []}
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  }), _vm._v(" "), _c('rank'), _vm._v(" "), _c('transition', {
	    attrs: {
	      "name": "play-slide"
	    },
	    on: {
